<?php
//working code from github
namespace App\Controller;

use App\Controller\WebHookController;
include WebHookController::class;


use RecursiveArrayIterator;
use RecursiveIteratorIterator;use function Composer\Autoload\includeFile;
...
\Stripe\Stripe::setApiKey('sk_test_51HjoRfIaBaXJG6ud5YpkWXn8uS5d6JLO4SWIa0pYfyNx9f8afcK3hYmnKx0Rcu5F446huOqmFxm2RaIDDViugybE00nkegCBQx');
...
if($event_json){
    ...
    $id = searchArrayValueByKey($event_json, 'data/metadata/id');
}else{
    echo 'No event recieved';
}
