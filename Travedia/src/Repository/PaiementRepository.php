...
public function searchP($term){
    return $this->createQueryBuilder('Paiement')
        ->andWhere('Paiement.owner.nom LIKE :nom')
        ->orWhere('Paiement.client.nom LIKE :nom')
        ->orWhere('Paiement.prix LIKE :nom')
        ->orWhere('Paiement.statut LIKE :nom')
        ->orWhere('Paiement.typePaiement LIKE :nom')
